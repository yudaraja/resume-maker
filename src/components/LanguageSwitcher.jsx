    ...
    return (
        <div className="relative inline-block text-left">
            <button
                ...
                className="inline-flex items-center gap-1 rounded-full border border-gray-300 bg-white px-4 py-2 text-sm font-medium shadow-sm hover:bg-gray-100"
            >
            ...
            {open && (
                <div className="ring-opacity-5 absolute right-0 z-10 mt-2 w-24 origin-top-right rounded-md bg-white shadow-lg">
                    <div className="py-1 text-sm">
                        <button
                            onClick={() => changeLanguage('en')}
                            className="flex w-full items-center justify-between gap-2 px-6 py-2 text-left hover:bg-gray-100"
                        >
                            <svg
